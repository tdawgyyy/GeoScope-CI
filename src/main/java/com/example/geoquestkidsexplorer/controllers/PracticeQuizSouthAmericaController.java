...
import com.example.geoquestkidsexplorer.data.SouthAmericaQuizData;
...
public class PracticeQuizSouthAmericaController {
    ...
    public void initialize() {
        questions = SouthAmericaQuizData.getPracticeQuestions();
