...
import com.example.geoquestkidsexplorer.data.NorthAmericaQuizData;
...
public class PracticeQuizNorthAmericaController {
    ...
    public void initialize() {
        questions = NorthAmericaQuizData.getPracticeQuestions();
    ...
    private void backToGameModes(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/geoquestkidsexplorer/northamerica.fxml"));
